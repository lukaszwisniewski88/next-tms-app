...
import WithPageAuthRequired from '../hooks/withPageAuthRequired';

function MainLayout(Component) {
  return WithPageAuthRequired((props) => (
      ...
      <div tw='flex-1 flex flex-col gap-2'>
        <div tw='px-3.5 py-2 h-14 bg-purple-50  flex flex-row w-full gap-4 items-center'>
          <span tw='text-lg font-semibold flex-1'>
            {Component.PageTitle || 'No Name Page'}
          </span>
          <input
        ...
        <div tw='flex-1 overflow-auto m-1 p-2 max-w-full'>
          {' '}
          <Component {...props} />{' '}
        </div>
      </div>
